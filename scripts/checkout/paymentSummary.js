    ...
    paymentSummaryHTML+=
        `
            ...
            <div class="payment-summary-row">
                ...
                <div class="payment-summary-money js-shipping-money">$${formatCurrency(shippingPriceCents)}</div>
            </div>
            ...
            <div class="payment-summary-row total-row">
                <div>Order total:</div>
                <div class="payment-summary-money js-total-money">$${formatCurrency(totalCents)}</div>
            </div>
